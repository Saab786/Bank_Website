...
<head>
    ...
    <title>Money bank/Contect us</title>
...
<body class="bg cs">
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="" class="active">Contact Us</a></li>
                        </ul>
    ...
    <section class="section" id="about">
        ...
        <img src="assets/images/icons8-customer-support-100.png"><br><br>
            <h2 style="font-weight: bold; color: rgb(143, 141, 141);">Get in Touch</h2>
            <p style="font-weight: bold; color: rgb(143, 141, 141);">Feel free to ask</p>
            <span></span>
        </center>
        <div class="container">
